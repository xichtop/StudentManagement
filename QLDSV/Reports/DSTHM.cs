...
{
    public partial class DSTHM : Form
    {
        public DSTHM()
        {
            InitializeComponent();
        ...
        private void DSTHM_Load(object sender, EventArgs e)
        {
            ...
            // this.txtMaMH.Text = this.lookUpEditMonHoc.EditValue.ToString();
        }
        ...
        {
            ExtraReport_DSTHM report = new ExtraReport_DSTHM(this.lookUpEditLop.EditValue.ToString());
            report.txtLop.Text = lookUpEditLop.Text;
            report.txtMonHoc.Text = lookUpEditMonHoc.Text;
            report.txtLanThi.Text = numericLanThi.Value.ToString();
            report.txtAuthor.Text = "Người In Ấn : " + Program.MHoten;
            report.txtNgay.Text = this.dateNgayThi.Value.ToString("dd-MM-yyyy");
